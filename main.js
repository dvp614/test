/**
 * 내안의짐승 - 4축 매트릭스 기반 고도화된 분석 알고리즘
 */

const quizData = {
    // 4가지 축(E/I, S/N, T/F, J/P)별로 3문제씩 배치하여 총 12문제 구성
    questions: [
        // [Axis 1: E vs I]
    ...
    // 16종 동물의 심리학적 프로필 (MBTI 유형과 1:1 매칭으로 타당성 확보)
    results: {
        "ENTJ": { id: "lion", title: "카리스마 있는 전략 리더 '사자'", emoji: "🦁", hue: 35, keyword: "lion", advice: "취약성을 드러내는 것이 때로는 더 큰 신뢰를 구축합니다." },
        "ISTP": { id: "tiger", title: "독립적인 야심가 '호랑이'", emoji: "🐯", hue: 25, keyword: "tiger", advice: "타인의 부족함을 비난하기보다 성장을 돕는 스승의 태도를 가져보세요." },
        "ISTJ": { id: "wolf", title: "원칙과 충직의 가디언 '늑대'", emoji: "🐺", hue: 210, keyword: "wolf", advice: "가끔은 예외를 인정하는 유연함이 집단을 더 건강하게 만듭니다." },
        "ENTP": { id: "fox", title: "영리한 전술가 '여우'", emoji: "🦊", hue: 45, keyword: "fox", advice: "모든 것을 머리로만 해결하려 하지 마세요. 우직한 진심이 더 큰 문을 엽니다." },
        "ENFJ": { id: "dolphin", title: "공감하는 소셜 마스터 '돌고래'", emoji: "🐬", hue: 200, keyword: "dolphin", advice: "건강한 거리두기가 당신의 다정함을 더 오래 유지시켜 줍니다." },
        "ISFJ": { id: "dog", title: "한결같은 서포터 '리트리버'", emoji: "🦮", hue: 50, keyword: "dog", advice: "자신의 경계를 지킬 때 당신의 선의도 더욱 가치 있어집니다." },
        "ISFP": { id: "cat", title: "독립적인 심미안 '고양이'", emoji: "🐈", hue: 280, keyword: "cat", advice: "가끔은 당신의 아름다운 세계를 타인과 공유해 보세요." },
        "INTJ": { id: "owl", title: "냉철한 통찰가 '부엉이'", emoji: "🦉", hue: 260, keyword: "owl", advice: "80%의 확신이 있다면 행동으로 옮기며 배워가는 유연성을 가져보세요." },
        "ESFJ": { id: "elephant", title: "묵직한 신뢰의 아이콘 '코끼리'", emoji: "🐘", hue: 190, keyword: "elephant", advice: "변화의 파도를 타고 유연하게 움직이는 법을 익혀보세요." },
        "ESTJ": { id: "eagle", title: "비전을 그리는 전략가 '독수리'", emoji: "🦅", hue: 220, keyword: "eagle", advice: "위대한 비전은 현실의 토대 위에서 완성됩니다." },
        "INFP": { id: "sloth", title: "평화로운 힐링 마스터 '나무늘보'", emoji: "🦥", hue: 85, keyword: "sloth", advice: "중요한 목표 앞에서는 에너지를 집중하는 법을 연습해 보세요." },
        "ENFP": { id: "panda", title: "유니크한 낙천가 '판다'", emoji: "🐼", hue: 10, keyword: "panda", advice: "최소한의 현실적 책임감을 갖추어 보세요." },
        "INTP": { id: "snake", title: "지적인 관찰자 '뱀'", emoji: "🐍", hue: 140, keyword: "snake", advice: "투명함이 당신의 지적인 매력을 더욱 돋보이게 할 것입니다." },
        "ESTP": { id: "horse", title: "역동적인 자유 영혼 '말'", emoji: "🐎", hue: 30, keyword: "horse", advice: "당신이 지나온 길의 발자국을 확인하며 완결성을 높여보세요." },
        "ESFP": { id: "monkey", title: "재치 있는 아이디어 뱅크 '원숭이'", emoji: "🐒", hue: 40, keyword: "monkey", advice: "당신의 다재다능함이 전문성이라는 줄기를 만나게 하세요." },
        "INFJ": { id: "turtle", title: "끈기 있는 완결자 '거북이'", emoji: "🐢", hue: 120, keyword: "turtle", advice: "당신의 끈기에 효율이 더해지면 무적입니다." }
    }
};
...
function showResult() {
    ...
    setTimeout(() => {
        ...
        // 상세 설명은 HTML 파일에서 가져오는 링크 구조이므로, 간단 요약만 표시
...
console.log('내안의짐승 로직 점검 및 고도화 완료');
