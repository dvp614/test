...
const quizData = {
    questions: [
        ...
        { id: 7, text: "남들이 보는 당신의 주된 이미지는?", options: [{ text: "열정적이고 에너지가 넘치는 사람", weights: { tiger: 2, horse: 2, dolphin: 2, monkey: 2 } }, { text: "차분하고 믿음직스러운 사람", weights: { elephant: 2, polarbear: 2, turtle: 2, owl: 2 } }] },
    ...
    results: {
        lion: { title: "카리스마 있는 전략 리더 '사자'", emoji: "🦁", hue: 35, keyword: "lion", desc: "당신은 타고난 지배력과 전략적 사고를 지닌 리더입니다. 목표가 정해지면 주저 없이 행동하며, 카리스마로 공동체를 이끕니다." },
        tiger: { title: "독립적인 야심가 '호랑이'", emoji: "🐯", hue: 25, keyword: "tiger", desc: "강력한 경쟁심과 독립심을 지녔습니다. 타인의 도움 없이도 스스로 길을 개척하며 결과로 자신의 가치를 증명합니다." },
        wolf: { title: "원칙과 충직의 가디언 '늑대'", emoji: "🐺", hue: 210, keyword: "wolf", desc: "강한 책임감과 신념을 바탕으로 집단을 지킵니다. 겉으론 냉철해 보이지만 내면은 누구보다 뜨거운 충성심을 지녔습니다." },
        fox: { title: "영리한 전술가 '여우'", emoji: "🦊", hue: 45, keyword: "fox", desc: "상황 판단이 빠르고 재치가 넘칩니다. 고정관념에 얽매이지 않는 유연한 사고로 어떤 복잡한 문제도 효율적으로 해결합니다." },
        dolphin: { title: "공감하는 소셜 마스터 '돌고래'", emoji: "🐬", hue: 200, keyword: "dolphin", desc: "뛰어난 지능과 사회성을 바탕으로 공동체의 화합을 이끕니다. 타인의 감정을 읽는 능력이 탁월하며 긍정적인 에너지를 전파합니다." },
        dog: { title: "한결같은 서포터 '리트리버'", emoji: "🦮", hue: 50, keyword: "dog", desc: "따뜻한 공감 능력과 성실함을 지닌 평화주의자입니다. 자신의 이익보다 타인의 행복에서 더 큰 만족감을 느끼는 헌신적인 유형입니다." },
        cat: { title: "독립적인 심미안 '고양이'", emoji: "🐈", hue: 280, keyword: "cat", desc: "자기 주관이 뚜렷하며 독립적인 공간을 중요시합니다. 세밀한 관찰력과 미적 감각을 지녔으며 구속받는 것을 극도로 싫어합니다." },
        owl: { title: "냉철한 통찰가 '부엉이'", emoji: "🦉", hue: 260, keyword: "owl", desc: "감정에 휘둘리지 않는 객관적인 분석가입니다. 보이지 않는 핵심을 꿰뚫는 통찰력을 지녔으며 완벽주의적 성향이 강합니다." },
        elephant: { title: "묵직한 신뢰의 아이콘 '코끼리'", emoji: "🐘", hue: 190, keyword: "elephant", desc: "인내심과 기억력이 뛰어나며 집단의 안정을 최우선으로 합니다. 화를 잘 내지 않지만 결정적인 순간에는 엄청난 힘을 발휘합니다." },
        eagle: { title: "비전을 그리는 전략가 '독수리'", emoji: "🦅", hue: 220, keyword: "eagle", desc: "높은 곳에서 멀리 보는 통찰력과 결단력을 지녔습니다. 사소한 것에 연연하지 않고 거시적인 관점에서 목표를 포착합니다." },
        sloth: { title: "평화로운 힐링 마스터 '나무늘보'", emoji: "🦥", hue: 85, keyword: "sloth", desc: "서두르지 않고 자신만의 속도로 삶을 즐깁니다. 타인에게 경쟁심을 느끼지 않으며 존재 자체로 주변에 편안함을 줍니다." },
        panda: { title: "유니크한 낙천가 '판다'", emoji: "🐼", hue: 10, keyword: "panda", desc: "자신만의 독특한 라이프스타일을 추구하는 평화주의자입니다. 희소성 있는 매력을 지녔으며 복잡한 세상 속에서 순수함을 유지합니다." },
        snake: { title: "지적인 관찰자 '뱀'", emoji: "🐍", hue: 140, keyword: "snake", desc: "감정을 겉으로 드러내지 않고 상황을 냉정하게 관찰합니다. 최소한의 움직임으로 최대의 효율을 뽑아내는 전략적 효율가입니다." },
        horse: { title: "역동적인 자유 영혼 '말'", emoji: "🐎", hue: 30, keyword: "horse", desc: "멈추지 않는 에너지와 자유를 향한 갈망을 지녔습니다. 도전을 즐기며 새로운 환경에 뛰어드는 모험가적 기질이 강합니다." },
        monkey: { title: "재치 있는 아이디어 뱅크 '원숭이'", emoji: "🐒", hue: 40, keyword: "monkey", desc: "창의적인 발상과 사교적인 위트를 겸비했습니다. 지루한 것을 참지 못하며 끊임없이 새로운 재미와 자극을 만들어냅니다." },
        turtle: { title: "끈기 있는 완결자 '거북이'", emoji: "🐢", hue: 120, keyword: "turtle", desc: "느리지만 확실하게 목표에 도달하는 끈기의 대명사입니다. 원칙을 중시하며 한 번 시작한 일은 끝까지 책임지는 성실파입니다." }
    }
};
